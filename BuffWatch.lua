...
BUFFWATCHADDON.VERSION = "10.02";
BUFFWATCHADDON.RELEASE_DATE = "03 May 2023";
...
local maxBuffCount = 255;       -- Maximum number of buffs to check for on a single player
...
function BUFFWATCHADDON_G.OnLoad(self)
    ...
    GroupBuffs.Buff["Netherwinds"] = 1;

    GroupBuffs.GroupName[2] = "Mage Armor";
    GroupBuffs.Buff["Prismatic Barrier"] = 2;
    GroupBuffs.Buff["Ice Barrier"] = 2;
    GroupBuffs.Buff["Blazing Barrier"] = 2;
    ...
    GroupBuffs.Buff["Flask of the Undertow"] = 3;
    GroupBuffs.Buff["Flask of the Vast Horizon"] = 3;
    GroupBuffs.Buff["Flask of the Currents"] = 3;
    GroupBuffs.Buff["Flask of Endless Fathoms"] = 3;
    ...
    -- 1 - Only match against the original caster
    SpecialBuffs["Beacon of Light"] = 1;
    SpecialBuffs["Beacon of Faith"] = 1;
